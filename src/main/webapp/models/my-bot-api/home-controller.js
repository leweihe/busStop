...
angular.module('myApp-bot-api').controller('HomeController', ['$scope', 'HomeService', 'AmapService', 'ManageRouteService', function ($scope, HomeService, AmapService, ManageRouteService) {
